...
function firstLetter(str) {
  const splitString = str.split(""); //turns str into array, splits every character because there is no split term
  return splitString[0]; // returns first position in array
}
